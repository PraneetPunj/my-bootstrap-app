...
export default function LexicalToolbar() {
  ...
  return (
    <div className="btn-group mb-3 d-flex justify-content-center" role="group" aria-label="Formatting toolbar" style={{background: '#f8f9fa', borderRadius: '0.5rem', boxShadow: '0 2px 8px rgba(0,0,0,0.05)', padding: '0.5rem 0'}}>
      ...
      <button type="button" className="btn btn-outline-primary mx-1 d-flex align-items-center" style={{fontSize: '1.25rem', minWidth: '40px'}} onClick={() => format('underline')} title="Underline">
        <span className="me-1"><i className="bi bi-type-underline"></i></span>
